...
impl crypto::SupportedKxGroup for SecP384R1 {
    fn start(&self) -> Result<Box<dyn crypto::ActiveKeyExchange>, rustls::Error> {
        Ok(Box::new(KeyExchangeSecP384r1::use_secp384r1()))
    }
...
impl crypto::SupportedKxGroup for SecP521R1 {
    fn start(&self) -> Result<Box<dyn crypto::ActiveKeyExchange>, rustls::Error> {
        Ok(Box::new(KeyExchangeSecP521r1::use_secp521r1()))
    }
...
impl crypto::ActiveKeyExchange for KeyExchangeSecP384r1 {
    fn complete(
        self: Box<Self>,
        peer_pub_key: &[u8],
    ) -> Result<crypto::SharedSecret, rustls::Error> {
...
impl crypto::ActiveKeyExchange for KeyExchangeSecP521r1 {
    fn complete(
        self: Box<Self>,
        peer_pub_key: &[u8],
    ) -> Result<crypto::SharedSecret, rustls::Error> {
