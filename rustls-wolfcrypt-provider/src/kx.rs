...
//            //     panic!("failed when calling wc_InitRng");
//            // }
//            // ret = wc_curve25519_make_key(&mut rng, 32, peer_pub_key_object.as_ptr());
//            // if ret != 0 {
//            //     panic!("failed when calling wc_curve255519_init");
//            // }
//            // ret = wc_curve25519_import_public(peer_pub_key.as_ptr(), out_length, peer_pub_key_object.as_ptr());
//            // if ret != 0 {
